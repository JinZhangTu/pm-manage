  ...
  <div id="real-estate-edit" class="panel-bg" v-if="data!=null">
    <el-form :label-position="labelPosition" label-width="140px">
      <el-form-item label="楼号">
        <el-col :span="13">
          <el-input v-if="type!='detail'" v-model="data.lh"></el-input>
          <div v-if="type=='detail'" class="pull-left">{{data.lh}}</div>
        </el-col>
      </el-form-item>
      <el-form-item label="单元">
        <el-col :span="13">
          <el-select v-model="data.dy" placeholder="请选择" v-if="type!='detail'" style="width:100%;">
      ...
      <el-form-item label="门号">
        <el-col :span="13">
          <el-input v-if="type!='detail'" v-model="data.mh"></el-input>
          <div v-if="type=='detail'" class="pull-left">{{data.mh}}</div>
        </el-col>
      </el-form-item>
      <el-form-item label="结构">
        <el-col :span="13">
          <el-select v-model="data.jg" placeholder="请选择" v-if="type!='detail'" style="width:100%;">
      ...
      <el-form-item label="面积">
        <el-col :span="13">
          <el-input v-if="type!='detail'" v-model="data.mj"></el-input>
          <div
            v-if="type=='detail'"
            class="pull-left"
      ...
      <div>
        <el-button v-if="type=='add'" @click="addRealEstate()" type="primary" class="btn-w90">新增</el-button>
